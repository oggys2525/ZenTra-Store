...
const Dashboard = () => {
 ...
 <div 
 key={idx} 
 className="bg-white p-4 sm:p-5 rounded-2xl flex items-center justify-between premium-shadow"
 >
 ...
 <div className="lg:col-span-2 bg-white p-5 sm:p-6 rounded-3xl premium-shadow space-y-6">
 ...
 <div className="bg-white p-5 sm:p-6 rounded-3xl premium-shadow flex flex-col h-[400px] lg:h-auto">
