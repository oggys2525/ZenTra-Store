...
IF OBJECT_ID('dbo.StoreSettings', 'U') IS NOT NULL
...
(N'អាវយឺតបុរស ម៉ូដទាន់សម័យ', 1, N'អាវយឺតដៃខ្លីសម្រាប់បុរស សាច់ក្រណាត់កប្បាស ១០០% ទន់ត្រជាក់ និងស្រួលពាក់។', 15.00, 12.00, 50, 'M,L,XL,XXL', 'Black,White,Navy Blue', '/uploads/products/mens_tshirt.jpg', 'Active'),
(N'រ៉ូបនារី ម៉ូដផ្កាស្អាតៗ', 2, N'រ៉ូបវែងម៉ូដផ្កាសម្រាប់នារី សមស្របសម្រាប់ដើរកម្សាន្ត ឬកម្មវិធីផ្សេងៗ។', 25.00, 20.00, 30, 'S,M,L', 'Pink,Yellow', '/uploads/products/women_dress.jpg', 'Active'),
(N'ខោខូវប៊យបុរស រាងស្លីម', 1, N'ខោខូវប៊យជើងវែងបុរស សាច់យឺត ពណ៌ធ្យូង រាងស្លីមហ្វីត ស្អាតខ្លាំង។', 30.00, NULL, 40, '29,30,31,32,33,34', 'Blue Denim,Black Denim', '/uploads/products/mens_jeans.jpg', 'Active'),
(N'អាវធំសម្រាប់នារី បែបការិយាល័យ', 2, N'អាវធំ Blazer សម្រាប់នារីការិយាល័យ រាងស្អាត សាច់ក្រណាត់ប្រណិត។', 35.00, 29.99, 20, 'S,M,L,XL', 'Beige,Black,Pink', '/uploads/products/women_blazer.jpg', 'Active'),
(N'ស្បែកជើងប៉ាតាកីឡា ស្រាលស្រួលដើរ', 4, N'ស្បែកជើងប៉ាតាកីឡា ម៉ាកល្បី ទម្ងន់ស្រាល ជួយការពារជើង និងធ្វើឱ្យងាយស្រួលរត់ ឬដើរ។', 45.00, 38.00, 15, '39,40,41,42,43', 'White-Red,Grey,Black', '/uploads/products/sports_shoes.jpg', 'Active'),
(N'កាតាបស្ពាយចំហៀងនារី ម៉ូដប្រណិត', 5, N'កាតាបស្បែកពិតប្រាកដ ទំហំល្មម ម៉ូដទាន់សម័យ ងាយស្រួលដាក់សម្ភារៈប្រចាំថ្ងៃ។', 55.00, NULL, 12, 'One Size', 'Brown,Black,Cream', '/uploads/products/women_bag.jpg', 'Active'),
(N'អាវយឺតកូនក្មេង រូបគំនូរគួរឱ្យស្រឡាញ់', 3, N'អាវយឺតដៃខ្លីកូនក្មេង រូបគំនូរតុក្កតាស្អាតៗ សាច់ក្រណាត់ទន់មិនរមាស់ស្បែក។', 8.50, 6.00, 100, '2Y,4Y,6Y,8Y', 'Yellow,Light Blue,Pink', '/uploads/products/kids_tshirt.jpg', 'Active');
GO
